...
This repository is linked with the publicly available dataset ["Structural and dynamic embedding of the mouse functional connectome revealed by functional ultrasound imaging (fUSI)"](10.5281/zenodo.18486492). The current version is curated to run with v0.1.1 of the dataset. The structure is as follow:
- `libraries` contains resources for the code to run (colormap)
